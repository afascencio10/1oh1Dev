...
ActiveRecord::Schema.define(version: 20191108163303) do
  ...
  add_foreign_key "bookings", "explores", name: "bookings_explore_id_fkey2", on_delete: :nullify
  ...
  add_foreign_key "bookings", "guides", name: "bookings_guide_id_fkey2", on_delete: :nullify
  ...
  add_foreign_key "explore_ratings", "explores", name: "explore_ratings_explore_id_fkey2", on_delete: :cascade
  ...
  add_foreign_key "explore_ratings", "guides", name: "explore_ratings_guide_id_fkey2", on_delete: :cascade
  ...
  add_foreign_key "explore_ratings", "profiles", name: "explore_ratings_profile_id_fkey2"
  ...
  add_foreign_key "explores", "categories", name: "explores_category_id_fkey2", on_delete: :cascade
  ...
  add_foreign_key "explores", "profiles", name: "explores_profile_id_fkey2"
  ...
  add_foreign_key "guide_ratings", "explores", name: "guide_ratings_explore_id_fkey2", on_delete: :cascade
  ...
  add_foreign_key "guide_ratings", "guides", name: "guide_ratings_guide_id_fkey2", on_delete: :cascade
  ...
  add_foreign_key "guide_ratings", "profiles", name: "guide_ratings_profile_id_fkey2"
  ...
  add_foreign_key "guides", "categories", name: "guides_category_id_fkey2", on_delete: :cascade
  ...
  add_foreign_key "guides", "profiles", name: "guides_profile_id_fkey2"
  ...
  add_foreign_key "notifications", "users", name: "notifications_user_id_fkey2"
  ...
  add_foreign_key "profiles", "users", name: "profiles_user_id_fkey2"
  ...
  add_foreign_key "projects", "profiles", name: "projects_profile_id_fkey2"
